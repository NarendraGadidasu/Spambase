...
spam_base = dtclf_pruned(criterion='entropy',class_weight='balanced',random_state=55)
...
paramsS= {'Boost__n_estimators':[1,2,5,10,20,30,45,60,80,100],
...
spam_booster = AdaBoostClassifier(algorithm='SAMME',learning_rate=1,base_estimator=spam_base,random_state=55)
...
spam_clf = basicResults(pipeS,spam_trgX,spam_trgY,spam_tstX,spam_tstY,paramsS,'Boost','spam')        
...
pipeS.set_params(**spam_final_params)
iterationLC(pipeS,spam_trgX,spam_trgY,spam_tstX,spam_tstY,{'Boost__n_estimators':[1,2,5,10,20,30,40,50]},'Boost','spam')                
