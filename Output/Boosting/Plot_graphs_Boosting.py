...
res1 = res.loc[res['param_Boost__n_estimators'] == 20, :]
...
plt.title('Number of Iterations : 20 (Spambase)')
...
lc_train = pd.read_csv('{}_spam_LC_train.csv'.format(algo))

lc_test = pd.read_csv('{}_spam_LC_test.csv'.format(algo))
...
plt.title('Learning curve wrt Number of Estimators (Spambase)')
